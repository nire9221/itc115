...
// parameter and
// calculates a student's grade point average. The user will type a line of
// input containing the
// student's name, then a number that represents the number of scores, followed
// by that many
